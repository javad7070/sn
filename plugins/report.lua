...
local function run(msg, matches)
 ...
 if matches[1]:lower() == 'setmaster' or matches[1]:lower() == 'تنظیم مستر' and is_admin(msg) then
  ...
  if chk then
   ...
   return '_ایدی مستر ذخیره شد_'
    ...
    if matches[1]:lower() == 'report' or matches[1]:lower() == 'گزارش' and msg.reply_to_message_id_ then
  local user_name = ''
